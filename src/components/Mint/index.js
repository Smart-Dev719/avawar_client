      ...
      >
        <div className="PageMint d-flex justify-content-center flex-column align-items-center w-100">
          <div className="PageMintInRow d-flex justify-content-center">
            <div className="CardItem spec1 gap-3 d-flex flex-column justify-content-center align-items-center position-relative"></div>
            <div className="CardItem gap-3 d-flex flex-column justify-content-center align-items-center">
              ...
              <img
                ...
                alt=""
              />
              <div className="CounterInput d-flex justify-content-between">
                <span
            ...
            <div className="CardItem spec2 gap-3 d-flex flex-column justify-content-center align-items-center position-relative"></div>
          </div>
